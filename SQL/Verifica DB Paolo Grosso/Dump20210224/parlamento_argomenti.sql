...
CREATE TABLE `argomenti` (
  `idargomento` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `argomento` varchar(45) NOT NULL,
  `testo` longtext NOT NULL,
  `macroargomento` varchar(45) NOT NULL,
  `img` varchar(45) DEFAULT NULL,
  `fonti` mediumtext DEFAULT NULL,
  PRIMARY KEY (`idargomento`),
  KEY `fk_argomenti_idx` (`macroargomento`),
  CONSTRAINT `fk_argomento` FOREIGN KEY (`macroargomento`) REFERENCES `macroargomenti` (`macroargomento`) ON DELETE NO ACTION ON UPDATE NO ACTION
