...
--
-- Table structure for table `tab_materie`
--

DROP TABLE IF EXISTS `tab_materie`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tab_materie` (
...
--
-- Dumping data for table `tab_materie`
--

LOCK TABLES `tab_materie` WRITE;
/*!40000 ALTER TABLE `tab_materie` DISABLE KEYS */;
INSERT INTO `tab_materie` VALUES (1,'---'),(2,'Java'),(3,'SQL'),(4,'Inglese');
/*!40000 ALTER TABLE `tab_materie` ENABLE KEYS */;
UNLOCK TABLES;
